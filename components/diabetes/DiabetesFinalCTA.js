...
const trustPoints = [
  ...
  { Icon: CheckCircle2, text: 'Personalised Diabetic Plan' },
  { Icon: Wifi,         text: 'Online Available' },
];

export default function DiabetesFinalCTA({ onBookNow }) {
  ...
  return (
    <section className="bg-white py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <div
          ref={ref}
          className="opacity-0 translate-y-6 transition-all duration-700 bg-gradient-to-br from-brand-teal via-[#1a8a7a] to-[#0f6b5c] rounded-3xl p-10 md:p-16 text-center relative overflow-hidden"
        >
          {/* Decorative blobs */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/75 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-10 font-light">
              Don&apos;t spend another year managing blood sugar. Book your Diabetes Reversal
              Consultation and get a personalised plan backed by BCA analysis to fix the root cause.
            </p>
