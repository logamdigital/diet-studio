      ...
      <div className="bg-brand-purple border-t border-white/10 shadow-2xl px-4 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          <div className="hidden sm:block">
            ...
            <p className="text-white/60 text-xs font-light">Rs.200 initial consultation · Program pricing in session</p>
          </div>
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
            <span className="text-white/70 text-sm font-semibold">Rs.200</span>
            <button
              onClick={onBookNow}
